...
private:
    // Add initialization method enum here
    ...
    std::vector<std::vector<std::vector<double>>> weights;  // [layer][neuron][connection]
    ...
    void initializeWeights(InitializationMethod method);  // Added method declaration
